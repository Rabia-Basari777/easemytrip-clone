...
export const Flights = () => {
  ...
  useEffect(() => {
    ...
    let filteredFlights = flights.filter((e) => {
      ...
      if (!isSpiceJet && !isAirIndia && !isGoFirst && !isVistara && !isAirAsia && !isIndigo && !isNonStop && !isOneStop && !isTwoStop) {
        return true;
      }
        ...
        <div className={styles.filterDiv}>
          ...
          <div className={`${styles.filterDivs} ${styles.stopsDiv}`}>
            ...
            <div className={`${styles.stops}`}> 
                <input type="checkbox" name="nonstop" onClick={() => { handleChecked("non-stop") }}/>
              <p style={{ fontSize: "14px", marginTop: "16px", marginLeft: "15px", color: "rgb(51,51,51)" }}>Non Stop</p>
            </div>
            <div className={styles.stops}>
              <input type="checkbox" name="1 Stop" onClick={() => { handleChecked("1-stop") }} />
              <p style={{ fontSize: "14px", marginTop: "16px", marginLeft: "15px", color: "rgb(51,51,51)" }}>1 Stop</p>
            </div>
            <div className={styles.stops}>
              <input type="checkbox" name="2 Stops" onClick={() => { handleChecked("2-stops") }} />
              <p style={{ fontSize: "14px", marginTop: "16px", marginLeft: "15px", color: "rgb(51,51,51)" }}>2 Stops</p>
            </div>
          </div>
          <div className={`${styles.filterDivs} ${styles.flightIconDiv}`}>
            ...
            <div className={`${styles.stops}`}>
              <input type="checkbox" onClick={() => { handleChecked("Indigo") }} />
            ...
            <div className={styles.stops}>
              <input type="checkbox" onClick={() => { handleChecked("SpiceJet") }} />
            ...
            <div className={styles.stops}>
              <input type="checkbox" onClick={() => { handleChecked("AirAsia") }} />
            ...
            <div className={styles.stops}>
              <input type="checkbox" onClick={() => { handleChecked("Vistara") }} />
            ...
            <div className={styles.stops}>
              <input type="checkbox" onClick={() => { handleChecked("GO FIRST") }} />
            ...
            <div className={styles.stops}>
              <input type="checkbox" onClick={() => { handleChecked("Air India") }} />
            ...
            {filteredFlights.map((e) => {
              return <div key={e.id}>
                <div key={e.id} className={styles.flightDetailDiv}>
                    ...
                    <p onClick={() => { handleClick(e._id); setCount(count+1) }}>Flight Detail</p>
